...
${OBJECTDIR}/Object_desc.o: Object_desc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Object_desc.o Object_desc.cpp
...
${OBJECTDIR}/Short_desc.o: Short_desc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Short_desc.o Short_desc.cpp

${OBJECTDIR}/TravelTable.o: TravelTable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TravelTable.o TravelTable.cpp

${OBJECTDIR}/Vocabulary.o: Vocabulary.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Vocabulary.o Vocabulary.cpp
